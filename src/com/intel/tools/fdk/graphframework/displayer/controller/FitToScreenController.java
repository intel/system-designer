...
public abstract class FitToScreenController {
     ...
     */
    public static void fitToScreen(final GraphDisplayer displayer) {
        fitToScreen(displayer, Integer.MAX_VALUE);
    }
     ...
     */
    public static void fitToScreen(final GraphDisplayer displayer, final int scaleLimit) {
        setupScale(displayer, scaleLimit);
        centerContent(displayer);
    }

    private static void setupScale(final GraphDisplayer displayer, final int limit) {
        double scale;
    ...
    private static void centerContent(final GraphDisplayer displayer) {
        ...
        final Dimension delta =
                new Dimension(((viewDimension.width - topologyDimension.width) / 2) - topologyCoordinates.x,
