...
import com.intel.audioviz.example.widgets.AudioWaveformTraceWidgetProvider;
...
public class OpenCustomStereoAudioTrackWidgetOnlyWaveformHandler extends OpenAudioTrackHandler {
    @Override
    protected void setupAudioTrackPart(final IEclipseContext partContext) {
        ...
        /*
         * Replace the default IAudioTraceWidgetProvider (AudioTraceWidgetProviderAddon instance) by the custom
         * AudioWaveformTraceWidgetProvider which provides only AudioWaveformTraceWidget.
         */
        partContext.set(IAudioTraceWidgetProvider.class, new AudioWaveformTraceWidgetProvider());
    }
}
